...
class BookmarksTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsToMany('Categories', [
            ...
            'joinTable' => 'bookmarks_categories'
        ]);
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmpty('last_visited');

        $validator
            ->integer('no_visits')
            ->allowEmpty('no_visits');

        $validator
            ->scalar('bookmark_status')
            ->requirePresence('bookmark_status', 'create')
            ->notEmpty('bookmark_status');

    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('last_visited') ?></th>
                <th scope="col"><?= $this->Paginator->sort('no_visits') ?></th>
                <th scope="col"><?= $this->Paginator->sort('created') ?></th>
                <th scope="col"><?= $this->Paginator->sort('modified') ?></th>
                <th scope="col"><?= $this->Paginator->sort('bookmark_status') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($bookmark->favourite) ?></td>
                <td><?= $this->Number->format($bookmark->sort_order) ?></td>
                <td><?= h($bookmark->last_visited) ?></td>
                <td><?= $this->Number->format($bookmark->no_visits) ?></td>
                <td><?= h($bookmark->created) ?></td>
                <td><?= h($bookmark->modified) ?></td>
                <td><?= h($bookmark->bookmark_status) ?></td>
                <td class="actions">
